...
export default function useSessionController(
  ...
  return {
    sessionState: {
      ...
      serialSessionProfiles: raw.serialSessionProfiles,
    ...
    sessionRefs: {
      ...
      serialSessionProfilesRef: raw.serialSessionProfilesRef,
    ...
    sessionActions: {
      ...
      isSerialSession: raw.isSerialSession,
      getSessionKind: raw.getSessionKind,
