export const enUsTranslations = {
  ...
  "config.section.credentials": "Password Manager",
  ...
  "credentials.name": "Friendly name",
  "credentials.searchPlaceholder": "Friendly name or username",
  "credentials.empty": "No credentials saved for this type",
  "credentials.defaultMode": "Default reuse mode",
  "credentials.mode.reference": "Dynamic reference",
  "credentials.mode.copy": "Copy to session",
  "credentials.lockedHint":
    "Security data is locked. Unlock it before adding, editing, copying, or deleting credentials.",
  "credentials.passwordKeepHint": "Leave blank to keep the current password",
  "credentials.deleteTitle": "Delete credential",
  "credentials.deleteHint":
    "Referenced sessions will be detached and their username and password cleared.",
  "credentials.profileSource": "Authentication details",
  "credentials.select": "Select a credential",
  "credentials.reuseMode": "Reuse mode",
  "credentials.quickAdd": "New {kind} credential",
  ...
  "widget.broadcast": "Command Broadcast",
  ...
  "rdp.statusPanel.title": "Runtime Status",
  "rdp.statusPanel.triggerAriaLabel": "Open runtime status panel",
  "rdp.statusPanel.closeAriaLabel": "Close runtime status panel",
  "rdp.statusPanel.frameRate": "Frame Update Rate",
  "rdp.statusPanel.frameRateValue": "{value} updates/s",
  "rdp.statusPanel.clipboard": "Clipboard",
  "rdp.statusPanel.audio": "Remote Audio",
  "rdp.statusPanel.legendTitle": "Color Legend",
  "rdp.statusPanel.legend.normal": "Connected with updates",
  "rdp.statusPanel.legend.degraded": "Not ready or no updates",
  "rdp.statusPanel.legend.error": "Bridge closed",
  "rdp.statusPanel.state.connected": "Connected",
  "rdp.statusPanel.state.disconnected": "Disconnected",
  "rdp.statusPanel.state.disabled": "Disabled",
  "rdp.statusPanel.state.unavailable": "Unavailable",
  "rdp.audio.state.idle": "Audio idle",
  "rdp.audio.state.negotiating": "Negotiating",
  "rdp.audio.state.playing": "Playing",
  "rdp.audio.state.muted": "Muted",
  "rdp.audio.state.error": "Audio unavailable",
  "rdp.audio.state.unavailable": "Unavailable",
  "rdp.audio.actions.mute": "Mute",
  "rdp.audio.actions.unmute": "Unmute",
  ...
  "profile.ssh.routing.mode": "Proxy",
  "profile.ssh.routing.mode.direct": "Direct",
  "profile.ssh.routing.mode.system": "System Proxy",
  "profile.ssh.routing.mode.manual": "Manual Proxy",
  "profile.ssh.routing.mode.jump": "Jump Hosts",
  "profile.ssh.proxy.systemHint":
    "Reads the current OS proxy settings at connection time; falls back to direct when unset.",
  "profile.ssh.proxy.protocol": "Protocol",
  "profile.ssh.proxy.host": "Proxy Host",
  "profile.ssh.proxy.port": "Proxy Port",
  "profile.ssh.proxy.username": "Proxy User",
  "profile.ssh.proxy.password": "Proxy Password",
  "profile.ssh.proxy.dns": "DNS Lookup",
  "profile.ssh.proxy.dnsEnabled": "Use proxy for DNS lookup",
  "profile.ssh.jump.empty": "No SSH sessions are available.",
  "profile.ssh.jump.node": "Hop {index}",
  "profile.ssh.jump.add": "Add Hop",
  "profile.ssh.jump.remove": "Remove",
  "profile.ssh.jump.selectPlaceholder": "Select an SSH session",
  "profile.ssh.jump.selectHint": "Select the first jump host.",
  "profile.ssh.imported.title": "OpenSSH Imports",
  "profile.ssh.imported.hint":
    "ProxyJump is mapped to a jump chain when possible; ProxyCommand is saved for display but not executed.",
  ...
  "profile.icon.pickerTitle": "Choose Session Icon",
  "profile.icon.clear": "Clear Icon",
  "profile.icon.default": "Default",
  "profile.icon.currentPreview": "Current session icon preview",
  ...
  "profile.auth.credential": "Credential",
  ...
  "serial.search.placeholder": "Search profiles or ports",
  "serial.profiles.title": "Serial Profiles",
  "serial.profiles.empty": "No serial profiles",
  "serial.ports.title": "Current Ports",
  "serial.ports.empty": "No serial ports found",
  "serial.port.saveAsProfile": "Save as profile",
  "serial.profile.new": "Add Profile",
  "serial.profile.modalTitle": "Serial Profile",
  "serial.profile.name": "Name",
  "serial.profile.port": "Port",
  "serial.profile.baudRate": "Baud Rate",
  "serial.profile.dataBits": "Data Bits",
  "serial.profile.stopBits": "Stop Bits",
  "serial.profile.parity": "Parity",
  "serial.profile.flowControl": "Flow Control",
  "serial.profile.encoding": "Text Encoding",
  "serial.profile.lineEnding": "Line Ending",
  "serial.profile.section.session": "Session",
  "serial.profile.section.protocol": "Protocol",
  "serial.profile.selectPort": "Select a serial port",
  "serial.profile.portUnavailable": "Unavailable",
  "serial.profile.customBaud": "Custom",
  "serial.profile.required": "Name and port are required.",
  "serial.profile.invalidBaud": "Baud rate must be a positive integer.",
  "serial.parity.none": "None",
  "serial.parity.odd": "Odd",
  "serial.parity.even": "Even",
  "serial.flowControl.none": "None",
  "serial.flowControl.software": "Software (XON/XOFF)",
  "serial.flowControl.hardware": "Hardware (RTS/CTS)",
  "serial.lineEnding.none": "None",
  "serial.lineEnding.cr": "CR",
  "serial.lineEnding.lf": "LF",
  "serial.lineEnding.crlf": "CRLF",
  "serial.connect.failed": "Serial connection failed",
  "error.serial.portInUse":
    "Serial port {portName} is already connected in a session.",
  "error.serial.operationFailed": "Serial operation failed",
  "error.sftp.operationFailed": "SFTP operation failed",
  "error.ssh.operationFailed": "SSH operation failed",
  "error.proxy.operationFailed": "Proxy operation failed",
  "error.rdp.operationFailed": "RDP operation failed",
  "error.remoteEdit.operationFailed": "Remote edit operation failed",
  "error.ai.operationFailed": "AI operation failed",
  "error.security.operationFailed": "Security operation failed",
  "error.system.operationFailed": "System operation failed",
  "error.session.operationFailed": "Session operation failed",
  "error.backend.operationFailed": "Backend operation failed",
  "error.serial.portListFailed": "Failed to enumerate system serial ports",
  "error.serial.stateUnavailable": "Serial session state is unavailable",
  "error.serial.readFailed":
    "Failed to read from the serial port or the device was disconnected",
  "error.serial.writeFailed": "Failed to write to the serial port",
  ...
  "error.serial.baudRateInvalid": "Serial baud rate must be greater than zero",
  "error.serial.encodingUnavailable": "GB18030 encoding is unavailable",
  "error.serial.textEncodeFailed":
    "The text contains characters that cannot be represented in GB18030",
  "error.serial.externalPortInUse":
    "The target serial port is in use by another application",
  "error.serial.openFailed": "Failed to open the target serial port",
  "error.serial.profileNameRequired": "Serial profile name is required",
  "error.serial.profileReadFailed": "Failed to read the serial profile file",
  "error.serial.profileParseFailed": "Failed to parse the serial profile file",
  "error.serial.profileWriteFailed": "Failed to save the serial profile file",
  "error.serial.groupsReadFailed": "Failed to read the serial group file",
  "error.serial.groupsParseFailed": "Failed to parse the serial group file",
  "error.serial.groupsWriteFailed": "Failed to save the serial group file",
  "serial.split.unsupported":
    "Serial sessions cannot duplicate connections when splitting",
  "serial.debug.textDisplay": "Text Display",
  "serial.debug.hexDisplay": "HEX Display",
  "serial.debug.textSend": "Text Send",
  "serial.debug.hexSend": "HEX Send",
  "serial.debug.hexSendState": "HEX Send · {pending}",
  "serial.debug.export": "Export Log",
  "serial.debug.keyboardInput": "Serial keyboard input",
  "serial.debug.send": "Send",
  "serial.debug.inputPlaceholder": "Enter data to send",
  "serial.debug.rx": "Receive",
  "serial.debug.tx": "Send",
  "serial.debug.empty": "Waiting for serial data. Start typing to send.",
  "serial.debug.invalidHex": "HEX input must contain complete two-digit bytes.",
  "serial.debug.save": "Save monitor log",
  "status.ai": "AI",
  ...
  "status.resource.usage": "Usage",
  "status.resource.cpuLogicalCores": "Logical Cores",
  "status.resource.uptime": "Uptime",
  ...
  "terminal.tabMenu.group.create": "Create And Join Group",
  "terminal.tabMenu.group.createTitle": "Create Session Group",
  "terminal.tabMenu.group.default": "Move To Default Group",
  "terminal.tabMenu.group.join": "Join {name}",
  "terminal.tabMenu.group.more": "More Groups...",
  "terminal.tabMenu.group.selectTitle": "Select Session Group",
  "terminal.tabMenu.group.searchPlaceholder": "Search groups",
  "terminal.tabMenu.group.noMatch": "No matching groups",
  "terminal.tabMenu.group.name": "Group Name",
  "terminal.tabMenu.group.namePlaceholder": "Enter group name",
  "terminal.tabMenu.group.nameRequired": "Enter a group name first",
  "terminal.tabMenu.group.nameDuplicate": "Group name already exists",
  ...
  "broadcast.scope.current": "Current",
  "broadcast.scope.group": "Current Group",
  "broadcast.scope.all": "All",
  "broadcast.scopeLabel": "Broadcast target",
  "broadcast.commandPlaceholder": "Enter the command to run across sessions",
  "broadcast.targetSummary": "Send to {count} sessions",
  "broadcast.repeatCount": "Send count",
  "broadcast.intervalSeconds": "Interval (s)",
  "broadcast.progressFinite": "Sent {sent}/{total}",
  "broadcast.progressInfinite": "Sent {sent}",
  "broadcast.send": "Send",
  "broadcast.stop": "Stop",
  ...
  "ai.code.plainText": "Text",
  "ai.code.copy": "Copy code",
  "ai.code.fillTerminal": "Fill terminal",
  "ai.code.noSession": "No active session",
  ...
  "transfers.active": "Active Transfers",
  "transfers.runningCount": "{count} transfers running",
  "transfers.empty": "No transfers are currently running",
  "transfers.cancelAria": "Cancel transfer {name} for session {session}",
